...
const FeatureSection = () => {
    ...
    return (
        <div className='px-6 md:px-16 lg:px-24 xl:px-44 oferflow-hidden'>
            <div className='relative flex items-center justify-between pt-20 pb-10'>
                <BlurCircle top='0' right='-80px' />

                <p className='text-gary-300 front-medium text-lg'>Now Showing</p>
            ...
            <div className='flex flex-wrap max-sm:jutify-center gap-8 mt-8'>
